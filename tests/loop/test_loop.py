        ...
        llm = MockLLM(
            responses=[
                Message(
                    ...
                    tool_calls=[
                        ToolCall(id="call_1", function=FunctionCall(name="read_file", arguments='{"path": "test.txt"}'))
                    ],
                ),
        ...
        llm = MockLLM(
            responses=[
                Message(
                    ...
                    content="reading...",
                    tool_calls=[
                        ToolCall(id="call_1", function=FunctionCall(name="read_file", arguments='{"path": "x.txt"}'))
                    ],
                ),
        ...
        llm = MockLLM(
            responses=[
                Message(
                    ...
                    tool_calls=[
                        ToolCall(
                            id="call_e1", function=FunctionCall(name="write_file", arguments='{"path": "test.txt"}')
                        )
                    ],
                ),
        ...
        llm = MockLLM(
            responses=[
                Message(
                    ...
                    tool_calls=[
                        ToolCall(id="call_s1", function=FunctionCall(name="read_file", arguments='{"path": "x.txt"}'))
                    ],
                ),
        ...
        llm = MockLLM(
            responses=[
                Message(
                    ...
                    content="reading...",
                    tool_calls=[
                        ToolCall(id="call_t1", function=FunctionCall(name="read_file", arguments='{"path": "big.txt"}'))
                    ],
                ),
        ...
        llm = MockLLM(
            responses=[
                ...
                Message(
                    ...
                    content="second call",
                    tool_calls=[
                        ToolCall(id="c2", function=FunctionCall(name="read_file", arguments='{"path": "y.txt"}'))
                    ],
                ),
            ]
        )
