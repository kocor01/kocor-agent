...
class TestSlidingWindowStrategy:
    ...
    def setup_method(self):
        ...
        self.strategy = SlidingWindowStrategy(summarizer=self.summarizer, preserve_rounds=2)
    ...
    def test_aggressive_mode(self):
        ...
        strategy = SlidingWindowStrategy(summarizer=self.summarizer, preserve_rounds=1)
        all_msgs = []
        for i in range(4):
            all_msgs.extend(make_round(f"问题{i}", f"回答{i}"))
